...
class TestHistoryEndpoints:
    ...
    def test_list_history_empty(self, client):
        ...
        with patch("api.routers.history.get_user_storage", return_value=mock_storage):
    ...
    def test_list_history_with_data(self, client, mock_r2_storage):
        ...
        with patch("api.routers.history.get_user_storage", return_value=mock_storage):
            with patch("api.routers.history.get_r2_storage", return_value=mock_r2_storage):
                response = client.get("/api/history")
    ...
    def test_get_history_item_not_found(self, client):
        ...
        mock_storage = MagicMock()
        mock_storage.get_history_item.return_value = None
    ...
    def test_get_history_item_success(self, client, mock_r2_storage):
        """Test getting existing history item."""
        mock_storage = MagicMock()
        mock_storage.get_history_item.return_value = {
    ...
    def test_delete_history_item_success(self, client):
        ...
        mock_storage = MagicMock()
        mock_storage.get_history_item.return_value = {"key": "test-item"}
    ...
    def test_get_history_image_not_found(self, client):
        ...
        mock_storage = MagicMock()
        mock_storage.load_image_bytes.return_value = None
    ...
    def test_get_history_image_success(self, client):
        ...
        mock_storage.load_image_bytes.return_value = b'\x89PNG\r\n\x1a\n' + b'\x00' * 100
